                         ...
                         <Box borderBottom='1px' borderColor='gray.300' my='5'>
                              ...
                              <Box className='cartcard' w='100%' justifyContent='space-between' p='3' py='8' alignItems='center'>
                                   ...
                                   <Box p='2' display={'flex'} justifyContent='center'>
                                        <Box>
                                             <Box h='30px' w='150px' display='flex' justifyContent='space-between' p='1' alignItems='center' border='1px' borderColor='gray.300' borderRadius='5px'>
                                             ...
                                             <Box display='flex' justifyContent='' alignItems={'center'}>
                                                  <Button bg='none' colorScheme='transparent' color='blackAlpha.700' borderRadius='0' fontSize='.7em' p='0' h='20px' my='2' onClick={() => deleteProduct(id)}>Delete</Button>
                                                  <Box borderRight='1px' borderColor='gray.200' h='20px' mx='1'></Box>
                                                  <Button bg='none' colorScheme='transparent' color='blackAlpha.700' borderRadius='0' fontSize='.7em' p='0' border='0px' h='20px' my='2'>Save for later</Button>
                                             </Box>
                                        </Box>
                                   </Box>
                                   <Box textAlign='right'>
