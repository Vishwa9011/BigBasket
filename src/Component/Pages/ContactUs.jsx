                              ...
                              <Wrap spacing={{ base: 20, sm: 3, md: 5, lg: 20 }}>
                                   <WrapItem>
                                        <Box>
                                             ...
                                             <Text mt={{ sm: 3, md: 3, lg: 5 }} color="gray.500">Fill up the form below to contact</Text>
                                   ...
                                   <WrapItem>
                                        <Box bg="white" borderRadius="lg">
                                             <Box m={8} color="#0B0E3F">
                                                  <VStack spacing={5}>
                                                       <form action="https://formspree.io/f/myyagewk" method='POST' className='contact-input'>
                                                            <FormControl id="name">
                                                                 <FormLabel>Your Name</FormLabel>
                                                                 <InputGroup borderColor="#E0E1E7">
                                                                      <InputLeftElement pointerEvents="none" children={<BsPerson color="gray.800" />} />
                                                                      <Input type="text" size="md" name='username' />
                                                                 </InputGroup>
                                                            </FormControl>
                                                            <FormControl id="name">
